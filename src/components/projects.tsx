  ...
  return (
    <>
      ...
      >
        {title}
        <span
          className="bg-green-500 size-1 rounded-full"
          aria-label="Active project indicator"
        />
      </a>
      <div
        className="font-mono hidden text-xs underline print:visible"
        aria-hidden="true"
      >
    ...
    >
      <CardHeader>
        <div className="space-y-1">
          ...
          <CardDescription
            className="font-mono text-pretty text-xs print:text-[10px]"
